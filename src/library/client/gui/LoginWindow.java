...
public class LoginWindow extends JFrame{
  ...
  public LoginWindow(String title, ProductClientController libraryClientController) throws HeadlessException {
    super(title);
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource()== loginButton){
        ...
        try{
          ...
          ProductWindow win = new ProductWindow("Product window for "+user, libraryClientController);
